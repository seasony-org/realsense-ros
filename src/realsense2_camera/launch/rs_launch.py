...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           #{'name': 'base_frame_id',                'default': 'camera_front', 'description': 'A realsense bagfile to run from as a device'},
                           #{'name': 'depth_frame_id',               'default': 'camera_front_depth_frame', 'description': 'A realsense bagfile to run from as a device'},
                           #{'name': 'depth_optical_frame_id',       'default': 'camera_front_depth_optical_frame', 'description': 'A realsense bagfile to run from as a device'},
                           #{'name': 'color_frame_id',               'default': 'camera_front_color_frame', 'description': 'A realsense bagfile to run from as a device'},
                           #{'name': 'color_optical_frame_id',       'default': 'camera_front_color_optical_frame', 'description': 'A realsense bagfile to run from as a device'},
                           #{'name': 'infra1_frame_id',              'default': 'camera_front_infra1_frame', 'description': 'A realsense bagfile to run from as a device'},
                           #{'name': 'infra1_optical_frame_id',      'default': 'camera_front_infra1_optical_frame', 'description': 'A realsense bagfile to run from as a device'},
                           #{'name': 'infra2_frame_id',              'default': 'camera_front_infra2_frame', 'description': 'A realsense bagfile to run from as a device'},
                           #{'name': 'infra2_optical_frame_id',      'default': 'camera_front_infra2_optical_frame', 'description': 'A realsense bagfile to run from as a device'},
